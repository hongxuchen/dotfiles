...
# aliases
alias mvn-cie='mvn clean install eclipse:eclipse'
alias mvn-ci='mvn clean install'
alias mvn-cist='mvn clean install -DskipTests'
alias mvn-e='mvn eclipse:eclipse'
alias mvn-ce='mvn clean eclipse:clean eclipse:eclipse'
alias mvn-d='mvn deploy'
alias mvn-p='mvn package'
alias mvn-c='mvn clean'
alias mvn-com='mvn compile'
alias mvn-ct='mvn clean test'
alias mvn-t='mvn test'
alias mvn-ag='mvn archetype:generate'
alias mvn--updates='mvn versions:display-dependency-updates'
alias mvn-tc7='mvn tomcat7:run' 
alias mvn-tc='mvn tomcat:run'
alias mvn-jetty='mvn jetty:run'
alias mvn-dt='mvn dependency:tree'
alias mvn-s='mvn site'
alias mvn-src='mvn dependency:sources'
alias mvn-docs='mvn dependency:resolve -Dclassifier=javadoc'
