...
;; ## added by OPAM user-setup for emacs / tuareg ## 6dc0d47bb5c5eb893cd385851f0e15f7 ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/home/hongxu/.opam/4.02.1/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
