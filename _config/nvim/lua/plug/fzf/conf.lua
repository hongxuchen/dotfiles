...
u.keymap("n", "<leader>dds", fzf.dap_configurations, u.opts, "[fzf] find dap_configurations")
u.keymap("n", "<leader>ddb", fzf.dap_breakpoints, u.opts, "[fzf] find dap_breakpoints")
u.keymap("n", "<leader>ddv", fzf.dap_variables, u.opts, "[fzf] find dap_variables")
u.keymap("n", "<leader>ddf", fzf.dap_frames, u.opts, "[fzf] find dap_frames")

u.keymap("n", "<leader>ll", "<Cmd>LazyPlugins<CR>", u.opts, "[fzf] list lazy plugins")
u.keymap("n", "<leader>li", "<Cmd>LspInfo<CR>", u.opts, "[fzf] LSP info")
